...
import (
	...
	serviceGrpc "github.com/syukri21/mercari/service_apigw/internal/generated/service_area"
...
func New(ctx context.Context, endpointPath string) (http.Handler, error) {
	...
	if err := serviceGrpc.RegisterServiceAreaHandlerFromEndpoint(ctx, gw, endpointPath, opts); err != nil {
		return nil, err
	}
